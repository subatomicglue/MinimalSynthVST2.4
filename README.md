...
Copy the proprietary `vstsdk2.4` you [downloaded from Steinberg](https://www.steinberg.net/en/company/developers.html) into `MinimalSynthVST2.4/`, For example, resulting structure will look like:
```
